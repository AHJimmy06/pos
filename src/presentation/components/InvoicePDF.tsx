...
export const InvoicePDF = forwardRef<HTMLDivElement, Props>(
	({ invoice, client, invoiceNumber }, ref) => {
		...
		return (
			<div
				ref={ref}
				className="p-16 bg-white text-black font-serif print:p-8"
			...
			>
				...
				<div className="grid grid-cols-2 gap-8 mb-12">
					<div className="border border-black p-4 rounded">
						<p className="text-[10px] font-bold uppercase mb-2 border-b border-black">
							Facturar a:
						</p>
					...
					<div className="flex flex-col justify-end text-right">
						<p className="text-sm">
							<span className="font-bold">Condición:</span> Venta de Contado
						</p>
					</div>
				</div>
      ...
      */}
				...
				<div className="mt-32 border-t border-gray-300 pt-8 text-center text-[10px] text-gray-500 uppercase tracking-widest">
					...
					<p className="mt-1">
						Documento no válido como factura fiscal en transacciones reales
					</p>
				</div>
			</div>
		);
